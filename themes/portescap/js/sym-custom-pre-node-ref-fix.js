...
jQuery(document).ready(function() {
	...
	jQuery('#header .mobile_menu, #block-menu-block-1 .nolink').click(function() {
		jQuery('#mobile_menu #block-menu-block-1 .menu').toggleClass('active');
		jQuery('#mobile_menu #block-menu-block-2 .menu').removeClass('active');
	});

	jQuery('#header .contact, #block-menu-block-2 .nolink').click(function() {
		jQuery('#mobile_menu #block-menu-block-2 .menu').toggleClass('active');
		jQuery('#mobile_menu #block-menu-block-1 .menu').removeClass('active');
	});
