					...
					<div class="span3">
						<div class="video-filter" style="color:#ED1c24;">
							<div class="video-filter-inner">
								...
								<span class="video-button filter-item translate active" value="all" en="All videos">All videos</span>
								<span class="video-button filter-item translate" value="Motor technology" en="Motor Technology">Motor Technology</span>
								<span class="video-button filter-item translate" value="Applications" en="Applications">Applications</span>
								<span class="video-button filter-item translate" value="Portescap capabilities and facilities" en="Capabilities and Facilities">Capabilities and Facilities</span>
							</div>
						</div>
					</div>
