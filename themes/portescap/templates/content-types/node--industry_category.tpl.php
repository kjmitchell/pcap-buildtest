...
hide($content['field_additional_industries']);
		...
		<div class="span10">
			...
			<div class="row-fluid">
				...
				<div class="span7">
					...
					<div id="motor-requirements" class="bordered">
						<div class="left">
			...
			<div class="row-fluid bordered">
				<div class="span12" id="other-applications">
					<?php print render($content['field_additional_industries']);	?>
				</div>
			</div>
		</div>
